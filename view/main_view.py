...
from view.command.employee.login_command import LoginCommand
...
class MainView(ttk.Frame):
    def __init__(self, root, *args, **kwargs):
        ...
        self.entry_img = PhotoImage(file=f"view/static/welcome_view/entry_img.png")
        self.login_img0 = PhotoImage(file=f"view/static/welcome_view/img0.png")
