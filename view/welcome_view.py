...
class WelcomeView(ttk.Frame):
    def __init__(self, root, *args, **kwargs):
        ...
        self.canvas = Canvas(root, bg="#f9f4f5", height=1024, width=1440, bd=0, highlightthickness=0, relief="ridge")
        ...
        self.b0 = Button(image=self.img0, borderwidth=0, background="#F9F4F5", command=self.btn_clicked, relief="flat")
        ...
        self.b1 = Button(image=self.img1, borderwidth=0, highlightthickness=0, background="#E0E0E0",
                         activebackground="#e0e0e0", command=self.btn_clicked, relief="flat")
        self.b1.place(x=1049, y=680, width=250, height=81)

        self.entry0_img = PhotoImage(file=f"view/static/welcome_view/img_textBox0.png")
        self.entry0_bg = self.canvas.create_image(1188.0, 480.0, image=self.entry0_img)
        self.entry0 = Entry(bd=0, bg="#e0e0e0", font=("Helevetica neue", 16), highlightthickness=0)
        self.entry0.place(x=1039, y=463, width=298, height=32)

        self.entry1_img = PhotoImage(file=f"view/static/welcome_view/img_textBox1.png")
        self.entry1_bg = self.canvas.create_image(1188.0, 610.0, image=self.entry1_img)
        self.entry1 = Entry(bd=0, bg="#e0e0e0", font=("Helevetica neue", 16), highlightthickness=0)
